...
data = importdata(fullfile('DailyMaxTGDataBattery.tsv'));

date = data.textdata(2:30627, 11);
...
title('Daily Maximum Water Levels at the Battery, NYC');
...
xlabel('Date');
ylabel('Water Level (mm)');
title('Detrended Daily Maximum Water Levels at The Battery, NYC');
